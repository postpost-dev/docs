...
<Tabs items={['JavaScript (fetch)', 'Python (requests)', 'cURL', 'Node.js (axios)']}>
...
<Tabs items={['JavaScript (fetch)', 'Python (requests)', 'cURL']}>
<Tab value="JavaScript (fetch)">
```javascript
...
- [Upload images and videos](/guides/media-uploads)
- [Post to specific platforms](/guides/cross-platform)
- [LinkedIn analytics](/endpoints/linkedin-statistics)
- [Workspace / B2B API](/guides/workspace)
