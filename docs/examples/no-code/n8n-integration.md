...
2. **HTTP Request** → POST to PostPost
...
5. **HTTP Request** → POST to PostPost
...
3. **HTTP Request** → POST to PostPost
...
4. **HTTP Request** → POST to PostPost
...
3. **HTTP Request** → GET upload URL from PostPost (with postGroupId)
